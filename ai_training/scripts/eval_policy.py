...
def render_gui(screen, font, font_bold, sim, ep, total_eps, step, max_steps, model_succ_prob, is_success, cam_img, latent_tokens=None, attn_maps=None):
    ...
    if cam_img is not None:
        ...
        cam_surf_scaled = pygame.transform.scale(cam_surf, (90, 90))
        screen.blit(cam_surf_scaled, (280, 280))
        pygame.draw.rect(screen, (100, 220, 255), (280, 280, 90, 90), 2)
        cam_tag = font.render("Overhead RGB Cam", True, (100, 220, 255))
        screen.blit(cam_tag, (265, 260))
    ...
    dist_str = f"Dist to Goal: {dist_to_goal*100:.1f} cm | Flow-Matching Horizon: 128 steps"
...
def evaluate(episodes=10):
    ...
    print("=" * 68)
    print("   Testing SmolVLA-2 Flow-Matching Neural Policy")
    print("=" * 68)
